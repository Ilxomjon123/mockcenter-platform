<template>
  <div class="container">
    <div class="box">
      ...
      <h2 v-if="mode === 'exam'">Exam Login</h2>
      <h2 v-else>Practice Login</h2>
      ...
      <form @submit.prevent="handleSubmit">
        ...
        <div class="form-group">
          <label for="password">{{ mode === 'exam' ? 'Test Code / Password' : 'Password' }}</label>
          <div class="password-input-wrapper">
            <input
              id="password"
              v-model="password"
              :type="showPassword ? 'text' : 'password'"
              :placeholder="mode === 'exam' ? 'Enter test code' : '••••••••'"
              required
              :disabled="authStore.isLoading"
            />
            <button
      ...
      <div v-if="mode === 'exam'" class="exam-info">
        <p>⚠️ Exam Mode Features:</p>
        <ul>
          <li>Full-screen required</li>
          <li>Strict timer enforced</li>
          <li>Navigation disabled</li>
          <li>Auto logout after submit</li>
        </ul>
      </div>
    </div>
  </div>
...
const mode = ref<'exam' | 'practice'>('exam')
